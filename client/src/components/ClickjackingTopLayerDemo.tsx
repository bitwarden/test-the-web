...
export function ClickjackingTopLayerDemo() {
  ...
  const [lureHasPointerEventsNone, setLureHasPointerEventsNone] =
    useState(true);
  ...
  }, [reclaimRunning, intervalMs, reclaimTopLayer]);
  ...
  return (
    <Container>
      ...
      <Controls
        opacity={opacity}
        lureHasPointerEventsNone={lureHasPointerEventsNone}
        intervalMs={intervalMs}
        reclaimRunning={reclaimRunning}
        onOpacityChange={setOpacity}
        onLureHasPointerEventsNoneChange={setLureHasPointerEventsNone}
      ...
      <Description>
        ...
        may toggle the <code>pointer-events: none</code> styling and watch the
        counters above after clicking to see where events ultimately land.
        Finally, you may use the buttons to simulate a script reclaiming the top
        layer (for example, if another legitimate top-layer element appears).
        This can be done once with the "Reclaim" button, or automatically at a
        specified interval.
      </Description>
      <Description>
      ...
      <Lure
        ...
        style={{
          opacity,
          pointerEvents: lureHasPointerEventsNone ? "none" : "auto",
        }}
      >
...
interface ControlsProps {
  opacity: number;
  lureHasPointerEventsNone: boolean;
  intervalMs: number;
  reclaimRunning: boolean;
  onOpacityChange: (value: number) => void;
  onLureHasPointerEventsNoneChange: (value: boolean) => void;
...
function Controls({
  opacity,
  lureHasPointerEventsNone,
  intervalMs,
  reclaimRunning,
  onOpacityChange,
  onLureHasPointerEventsNoneChange,
  onIntervalChange,
  onReclaimOnce,
  onToggleReclaiming,
}: ControlsProps) {
      ...
      <ControlsRow>
        ...
        <ToggleField>
          <input
            ...
            checked={lureHasPointerEventsNone}
            onChange={(event) =>
              onLureHasPointerEventsNoneChange(event.target.checked)
            }
          />
          <span>
